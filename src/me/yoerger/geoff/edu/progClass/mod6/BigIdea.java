...
public class BigIdea {
	 ...
	 * @param brief A brief description of the proposal
	 * @throws IllegalArgumentException if module is not between 6 and 10
	 */
	...
	/**
	 * @param s The new long description to add
	 */
	public void setNewDesc(String s) {
		this.descriptions.add(s);
	}
	/**
	 * @return The String representing the last entered long description using {@link #setNewDesc()}
	 */
