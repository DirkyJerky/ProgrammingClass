...
public class sixThree implements Analysis{
	...
	public void printQuestions(Printer p) {
		...
		p.printAnswer("Find differences in 2 cars MPG and cost per month");
		
		p.print("Discuss how this assignment relates to a real-life situation. (Required)");
		p.printAnswer("This could be used in marketing to show how a different brand of car is better thajn another");
		
		p.print("Reflect on your growth as a programmer. (Required)");
		p.printAnswer("I practiced how to make an abstract type and make a non-abstract model out of it.");
		
		p.print("Describe the biggest problem encountered and how it was fixed.");
		p.printAnswer("My lazzieness and typeing, hence the 'private static void appendTab(Object s, StringBuilder sb)' ");
		
		p.print("Describe at least one thing that will be done differently in the future.");
		p.printAnswer("Find ouy how to easily format a chart in the console.");
		
		p.print("Suggest how this assignment could be extended.");
		p.printAnswer("Show the results in a JFrame");
		...
		p.printAnswer("Whats the best was to use abstract classes");
		
		p.print("What unanswered question(s) do you have after writing this program?");
		p.printAnswer("Ive seen that abstract classes can be instantaded, how?");
