...
//		PictureEncoder pe = new PictureEncoder("P:\\Programming\\Workspace\\ProgrammingClass\\Refs\\Flowers.jpeg"); // Me
	...
	public void printQuestions(Printer printer) {
		...
		printer.printTab("Encode a secret message into an image");
		
		printer.print("Discuss how this assignment relates to a real-life situation. (Required)");
		printer.printTab("Cryptography is a huge part in modern society, this shows just one method");
		
		printer.print("Reflect on your growth as a programmer. (Required)");
		printer.printTab("I learned how to easily get the code points of characters");
		
		printer.print("Describe the biggest problem encountered and how it was fixed.");
		printer.printTab("Figuring out why in one runtime it is able to decode it perfectly but in another it doesnt..."
		...
		printer.printTab("Encode it with indiviual bits, not the bytes");
		
		printer.print("Suggest how this assignment could be extended.");
		printer.printTab("Find out a way to encode images without it ruining  a section of the image.");
		
		printer.print("Why isn’t the secret message actually visible in the image?");
		printer.printTab("Each image is one part of a pixel, pixels are only one color.");
		
		printer.print("How could you hide a solid white rectangle within an image?");
		printer.printTab("You can \"Hide\" one.... but you can loop over some pixels");
		
		printer.print("What question(s) of your own did you answer while writing this program?");
		printer.printTab("How to create a static runtime of a file.");
		
		printer.print("What unanswered question(s) do you have after writing this program?");
		printer.printTab("How to make it work all the time");
