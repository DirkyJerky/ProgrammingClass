package me.yoerger.geoff.edu.progClass.bookClasses.shapeExample;
...
public class Rectangle extends Shape
{
	 ...
	 * 
	 * @param firstPoint
	 *            first point used in defining the shape
	 * @param lastPoint
	 *            second point used in defining the shape
	 */
	 ...
	 * 
	 * @param x1
	 *            x value of the first point that defines the shape
	 * @param y1
	 *            y value of the first point that defines the shape
	 * @param x2
	 *            x value of the second point that defines the shape
	 * @param y2
	...
	public void draw(Graphics g)
	{
		...
		// and height
		g.drawRect(this.getMinX(), this.getMinY(), this.getWidth(),
		        this.getHeight());
	}
