  ...
  MouseListener, LineListener
{
  ...
  ///////    me.yoerger.geoff.edu.progClass.main parts of the gui  /////////////////////////////
  
  /** the me.yoerger.geoff.edu.progClass.main window */
  ...
  /**
   * Method to set the title on the me.yoerger.geoff.edu.progClass.main window
  ...
  /**
   * Method to create the me.yoerger.geoff.edu.progClass.main window 
   */
...
//    }
  ...
  {
    //the me.yoerger.geoff.edu.progClass.main panel, we'll add everything to this at the end
    ...
    /*
     ...
     added to the me.yoerger.geoff.edu.progClass.main soundPanel
     */
    ...
    /*
     ...
     me.yoerger.geoff.edu.progClass.main soundPanel
     */
...
private class SamplingPanel extends JPanel
  ...
  /*
  public static void me.yoerger.geoff.edu.progClass.main(String args[])
  {
    try{
      /*
