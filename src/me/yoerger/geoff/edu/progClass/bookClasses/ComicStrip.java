...
/**
 * Class to display a comic strip. A comic strip has 4 comic panels. Each comic
 * panel has a picture and one or more text balloons. A comic strip has a name
 * and an author.
 * 
...
public class ComicStrip extends JPanel {
	 ...
	 *            an array of panels
	 */
	public ComicStrip(final String theName, final String theAuthor,
			final ComicPanel[] thePanelArray) {
		this.name = theName;
	...
	/**
	 * Set up the graphics to display the comic strip
	 */
	private void init() {
		...
		for (int i = 0; i < this.panelArray.length; i++) {
			stripPanel.add(this.panelArray[i]);
			if (i < (this.panelArray.length - 1)) {
	...
	public static void main(final String[] args) throws ImageFormatException {
		...
		Picture p1 = new Picture(
				"C:\\intro-prog-java\\Alice\\ComicStrip\\panel1.jpg");
		// p1.grayscaleWithLuminance();
		Picture p2 = new Picture(
				"C:\\intro-prog-java\\Alice\\ComicStrip\\panel2.jpg");
		// p2.grayscaleWithLuminance();
		Picture p3 = new Picture(
				"C:\\intro-prog-java\\Alice\\ComicStrip\\panel3.jpg");
		// p3.grayscaleWithLuminance();
		Picture p4 = new Picture(
				"C:\\intro-prog-java\\Alice\\ComicStrip\\panel4.jpg");
		...
		SpeechBalloon b0 = new SpeechBalloon(new Point(20, 10), 100, new Point(
				97, 54), "Hey Baby!");
		panelArray[0].add(b0);
		SpeechBalloon b1 = new SpeechBalloon(new Point(102, 7), 100, new Point(
				164, 48), "Yikes!");
		panelArray[1].add(b1);
		SpeechBalloon b3 = new SpeechBalloon(new Point(23, 3), 150, new Point(
				108, 75), "I was just too hot for her!");
		panelArray[3].add(b3);
		ComicStrip strip = new ComicStrip("Snowman Love", "Barb Ericson",
				panelArray);
