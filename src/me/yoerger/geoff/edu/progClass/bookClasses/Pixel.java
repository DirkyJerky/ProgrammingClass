...
public class Pixel {
	 ...
	 */
	public void updatePicture(final int alpha, final int red, final int green,
			final int blue) {
	...
	public void setRed(final int value) {
		...
		this.updatePicture(this.getAlpha(), red, this.getGreen(),
				this.getBlue());
	}
	...
	public void setGreen(final int value) {
		...
		// update the pixel value in the picture
		this.updatePicture(this.getAlpha(), this.getRed(), green,
				this.getBlue());
	}
	...
	public void setBlue(final int value) {
		...
		// update the pixel value in the picture
		this.updatePicture(this.getAlpha(), this.getRed(), this.getGreen(),
				blue);
	}
	...
	public void setAlpha(final int value) {
		...
		// update the associated picture
		this.updatePicture(alpha, this.getRed(), this.getGreen(),
				this.getBlue());
	}
	...
	public String toString() {
		return "Pixel red=" + this.getRed() + " green=" + this.getGreen()
				+ " blue=" + this.getBlue();
	}
